...
var ethRegistrar;
function registrarInit(value) {
	ethRegistrar = value;
}
ens.owner(namehash('eth'),function(error, value) {
	registrarInit(auctionRegistrarContract.at(value))
	}
);
...
var testRegistrar;
function registrarInitTest(value) {
	testRegistrar = value;
}
ens.owner(namehash('test'),function(error, value) {
	registrarInitTest(fifsRegistrarContract.at(value))
	}
);
...
function registrarInitReverse(value) {
	reverseRegistrar = value;
}
ens.owner(namehash('addr.reverse'),function(error, value) {
	registrarInitReverse(reverseRegistrarContract.at(value))
	});
